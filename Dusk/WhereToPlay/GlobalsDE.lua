...
function CreateLocalizationInfo()
	...
	ZonesNamesAndLevel = {
		...
		zones128 = {mapHex =  0x41231343, texte = "K\195\182nigliches Gondor", lvl = "140 - 143", souCat = false},
		zones129 = {mapHex =  0x4124848f, texte = "\195\132u\195\159eres Gondor", lvl = "143 - 145", souCat = false},
		zones130 = {mapHex =  0x41248399, texte = "Schildinseln", lvl = "145 - 147", souCat = false},
		zones131 = {mapHex =  0x41248eef, texte = "Kap von Umbar", lvl = "147 - 150", souCat = false},
		zones132 = {mapHex =  0x41258005, texte = "Ikorb\195\162n-Tal", lvl = "150", souCat = false},
		zones133 = {mapHex =  0x41258014, texte = "Ambar\195\187l", lvl = "150", souCat = true},
		zones134 = {mapHex =  0x41258011, texte = "Kh\195\187d Zagin", lvl = "150", souCat = true},
		zones135 = {mapHex =  0x41258013, texte = "Imh\195\187lar", lvl = "150", souCat = true},
		zones136 = {mapHex =  0x41258009, texte = "Urash D\195\162r", lvl = "150", souCat = true},
		zones137 = {mapHex =  0x41267a39, texte = "M\195\187r Ghala (Der Grat des \195\156berflusses)", lvl = "151 - 160", souCat = false},
		zones138 = {mapHex =  0x41268397, texte = "Adag\195\173m", lvl = "151 - 152", souCat = true},
		...
		zones142 = {mapHex =  0x4127182a, texte = "Hatok\195\161li-H\195\188gel", lvl = "160", souCat = false}
        };
end