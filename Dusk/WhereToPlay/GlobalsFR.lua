...
function CreateLocalizationInfo()
	...
	------------------------------------------------------------------------------------------
	ZonesNamesAndLevel = {
        zones1 = {mapHex = 0x41008137, texte = "La Comt\195\169", lvl = "1 - 15", souCat = false},
		...
		zones4 = {mapHex = 0x41008136, texte = "Pays de Bree", lvl = "1 - 25, 30", souCat = false},
        zones5 = {mapHex = 0x41008136, texte = "Archet, Combe, Staddel", lvl = "1 - 15", souCat = true},
        zones6 = {mapHex = 0x41008136, texte = "Pays de Bree (nord), Nen Harn", lvl = "15 - 21", souCat = true},
		zones7 = {mapHex = 0x4110a842, texte = "Hauts des Galgals Sud", lvl = "20 - 25", souCat = true},
		zones8 = {mapHex = 0x41220239, texte = "Cardolan", lvl = "20 - 25", souCat = true}, -- new in U34
		zones9 = {mapHex = 0x4121994d, texte = "Comt\195\169 lointain", lvl = "20 - 23", souCat = false},
        zones10 = {mapHex = 0x41008130, texte = "Terres Solitaires", lvl = "20 - 35", souCat = false},
        zones11 = {mapHex = 0x41008130, texte = "L'Auberge Abandonn\195\169e", lvl = "18 - 23", souCat = true},
		...
		zones14 = {mapHex = 0x41008132, texte = "Hauts du Nord", lvl = "20 - 35", souCat = false},
		...
		zones19 = {mapHex = 0x412169ae, texte = "Trou\195\169e des Trolls", lvl = "35 - 40", souCat = false},
		...
		zones25 = {mapHex = 0x4120c7c8, texte = "Les Bois sauvages du Pays de Bree", lvl = "45 - 50", souCat = false},
		...
		zones30 = {mapHex = 0x410e871d, texte = "Voie de Durin", lvl = "53", souCat = true},
		zones31 = {mapHex = 0x410e871e, texte = "Zirakzigil", lvl = "53 - 54", souCat = true},
		zones32 = {mapHex = 0x410e8717, texte = "Syst\195\168me hydraulique", lvl = "54", souCat = true},
		...
		zones39 = {mapHex = 0x41100DF2, texte = "For\195\170t Noire", lvl = "61 - 65", souCat = false},
		...
		zones43 = {mapHex = 0x4111961d, texte = "Vall\195\169e des os", lvl = "66", souCat = true},
		...
		zones50 = {mapHex =  0x41116d55, texte = "Trou\195\169e du Rohan", lvl = "73 - 74", souCat = false},
		zones51 = {mapHex =  0x41116d55, texte = "Vall\195\169e d'Isen", lvl = "73", souCat = true},
		zones52 = {mapHex =  0x41116d55, texte = "Terretomb\195\169", lvl = "74", souCat = true},
		...
		zones57 = {mapHex =  0x4112d1dc, texte = "Mur de l'Est", lvl = "76 - 77", souCat = true},
		zones58 = {mapHex =  0x4112d1e0, texte = "Norcrofts", lvl = "78 - 80", souCat = true},
		zones59 = {mapHex =  0x4112d1e1, texte = "Vall\195\169e de l'Entalluve", lvl = "80 - 82", souCat = true},
		zones60 = {mapHex =  0x4112d1df, texte = "Sutcrofts", lvl = "83 - 85", souCat = true},
		zones61 = {mapHex =  0x411375af, texte = "Landes farouches", lvl = "85", souCat = true},
		...
		zones70 = {mapHex =  0x41154eed, texte = "Vall\195\169e de la Racine Noire", lvl = "95 - 97", souCat = true},
		...
		zones73 = {mapHex =  0x41158979, texte = "Marais des Morts", lvl = "100", souCat = false},
		zones74 = {mapHex =  0x4115b943, texte = "Centre du Gondor", lvl = "100", souCat = false},
		zones75 = {mapHex =  0x4115b93f, texte = "Val de Ringlo", lvl = "100", souCat = true},
		...
		zones89 = {mapHex =  0x4116af8b, texte = "Collines des balises", lvl = "103 - 104", souCat = true},
		zones90 = {mapHex =  0x4116B18E, texte = "Bataille des Champs du Pelennor", lvl = "105", souCat = true},
		...
		zones103 = {mapHex =  0x411c2de2, texte = "Eryn Lasgalen et les Terres de Dale", lvl = "115", souCat = false},
		...
		zones107 = {mapHex =  0x411CD4B8, texte = "Monts du Fer", lvl = "115 - 117", souCat = true},
		zones108 = {mapHex =  0x411c8da9, texte = "Ered Mithrin", lvl = "117 - 120", souCat = true},
		zones109 = {mapHex =  0x411da4a0, texte = "Val d'Anduin", lvl = "120", souCat = false},
		zones110 = {mapHex =  0x411e9a41, texte = "Vall\195\169e de Morgul", lvl = "120 - 130", souCat = false},
		...
		zones116 = {mapHex =  0x411fb86f, texte = "Val-d'A\195\175eul", lvl = "130", souCat = false},
		...
		zones128 = {mapHex =  0x41231343, texte = "Gondor royal", lvl = "140 - 143", souCat = false},
		zones129 = {mapHex =  0x41231342, texte = "Lossarnach", lvl = "140", souCat = true},
		zones130 = {mapHex =  0x4123145a, texte = "Haut-Lebennin", lvl = "140", souCat = true},
		zones131 = {mapHex =  0x4123145b, texte = "Bas-Lebennin", lvl = "140 - 141", souCat = true},
		zones132 = {mapHex =  0x4123145c, texte = "Pelargir", lvl = "140", souCat = true},
		zones133 = {mapHex =  0x412460a2, texte = "Val de Ringlo", lvl = "140 - 141", souCat = true},
		zones134 = {mapHex =  0x412460ab, texte = "Vall\195\169e de la Racine Noire", lvl = "141 - 142", souCat = true},
		zones135 = {mapHex =  0x412460a6, texte = "Lamedon", lvl = "141 - 142", souCat = true},
		...
		zones139 = {mapHex =  0x4124848f, texte = "Gondor ext\195\169rieur", lvl = "143 - 145", souCat = false},
		...
		zones142 = {mapHex =  0x41248399, texte = "Les \195\174les du Bouclier", lvl = "145 - 147", souCat = false},
		zones143 = {mapHex =  0x41248399, texte = "Zamarz\195\174r", lvl = "145", souCat = true},
		zones144 = {mapHex =  0x41248399, texte = "Bakhj\195\162d", lvl = "145 - 146", souCat = true},
		zones145 = {mapHex =  0x41248399, texte = "Jeb Kh\195\162tel", lvl = "146 - 147", souCat = true},
		zones146 = {mapHex =  0x41248eef, texte = "Cap d'Umbar", lvl = "147 - 150", souCat = false},
		zones147 = {mapHex =  0x41248eef, texte = "Khaph\195\162r", lvl = "147", souCat = true},
		zones148 = {mapHex =  0x41248eef, texte = "Bej M\195\162gha", lvl = "148 - 149", souCat = true},
		zones149 = {mapHex =  0x41248eef, texte = "Arad\195\162r", lvl = "149 - 150", souCat = true},
		zones150 = {mapHex =  0x41248eee, texte = "Umbar Baharb\195\170l", lvl = "148 - 150", souCat = true},
		zones151 = {mapHex =  0x41258005, texte = "Vall\195\169e d'Ikorb\195\162n", lvl = "150", souCat = false},
		zones152 = {mapHex =  0x41258014, texte = "Ambar\195\187l", lvl = "150", souCat = true},
		zones153 = {mapHex =  0x41258011, texte = "Kh\195\187d Zagin", lvl = "150", souCat = true},
		zones154 = {mapHex =  0x41258013, texte = "Imh\195\187lar", lvl = "150", souCat = true},
		zones155 = {mapHex =  0x41258009, texte = "Urash D\195\162r", lvl = "150", souCat = true},
		zones156 = {mapHex =  0x41267a39, texte = "M\195\187r Ghala (la Cr\195\170te de l'Abondance)", lvl = "151 - 160", souCat = false},
		zones157 = {mapHex =  0x41268397, texte = "Adagim", lvl = "151 - 152", souCat = true},
		zones158 = {mapHex =  0x4126838e, texte = "Kigh\195\162n", lvl = "153 - 155", souCat = true},
		zones159 = {mapHex =  0x41268388, texte = "An Sh\195\170ru", lvl = "156 - 158", souCat = true},
		zones160 = {mapHex =  0x41267a38, texte = "Idag\195\162l", lvl = "159 - 160", souCat = true},
		zones161 = {mapHex =  0x4127182a, texte = "Les Monts de l'Hatokali", lvl = "160", souCat = true}
        };
end