...
function CreateLocalizationInfo()
	...
	ZonesNamesAndLevel = {
		...
		zones129 = {mapHex =  0x4124848f, texte = "Gondor Ext\195\169rieur", lvl = "143 - 145", souCat = false},
		zones130 = {mapHex =  0x41248399, texte = "Les \195\174les du bouclier", lvl = "145 - 147", souCat = false},
		zones131 = {mapHex =  0x41248eef, texte = "Cap d\'Umbar", lvl = "147 - 150", souCat = false},
		zones132 = {mapHex =  0x41258005, texte = "Vall\195\169e d\'Ikorb\195\162n", lvl = "150", souCat = false},
		...
		zones137 = {mapHex =  0x41267a39, texte = "M\195\187r Ghala (la Cr\195\170te de l\'Abondance)", lvl = "151 - 160", souCat = false},
		zones138 = {mapHex =  0x41268397, texte = "Adagim", lvl = "151 - 152", souCat = true},
